...
<body>
	...
	<ul class="tswTabBox">
		<li class="tswTabSelected"><a>BIO</a></li>
		<li><a>WEBHOST</a></li>
		<li><a>CODE EDITOR</a></li>
		<li><a>GIT REPOSITORY</a></li>
	</ul>
	<div class="tswTabContent">
		<div class="tswTabContentSelected">
			<!--Content for tab 1-->
			<p>I am a C++ software engineer for AER - a weather company out in Lexington, MA. I am currently working on updating the software for the GOES-R weather satellite.</p>			
		</div>
		...
		<div class="tswTabContentUnselected">
			<!--Content for tab 4-->
			<p>
				<a href="https://github.com/phillybust3r/dwa">https://github.com/phillybust3r/dwa</a>
			</p>
		</div>
	</div>
</div>
